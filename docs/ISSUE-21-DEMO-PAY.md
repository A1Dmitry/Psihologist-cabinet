...
>
> **Обновление 2026-09-26 (issue #121, R14):** канон ужесточён — демо-оплаты нет ни при
> живом сервере, ни без него; `completePayment`/`demoPayIsLocalOnly`/режим `local-demo`
> удалены, без сервера запись вообще не создаётся. Описание ниже — историческое состояние
> на 2026-09-25; актуальный контракт — `docs/ISSUE-121-REPORT.md`, тест
> `tests/demo-pay-honesty.mjs` переписан под новый канон с сохранением негативных контролей.
