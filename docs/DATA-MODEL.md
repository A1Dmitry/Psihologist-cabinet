...
Клиентская страница `/psy/{slug}` = SEO-лендинг (профиль + услуги + реквизиты + контакты)
и форма записи на однойcanonical-странице; у залогиненного владельца — панель управления.
