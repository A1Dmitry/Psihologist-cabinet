...
>
> **Обновление политики 2026-09-24:** упоминания Auth OTP как резервного канала в этом отчёте отражают историческую реализацию на дату аудита; новый login-code flow теперь использует только `auth-code` и fail-closed при любой ошибке. Текущий статус — `docs/CURRENT-STATE.md` / SR-006.
>
